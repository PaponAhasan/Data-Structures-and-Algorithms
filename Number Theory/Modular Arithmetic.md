...
সিপিউর জন্য mod খুব costly একটা অপারেশন। যোগ,গুণের থেকে mod করতে অনেক বেশি সময় লাগে। অপ্রয়োজনে mod ব্যবহার করলে কোড time limit exceed করতে পারে,তাই overflow হবার আশংকা না থাকলে সব জায়গায় mod করা দরকার নেই ।তাই সম্ভব হলে মডুলো অপারেশন ব্যবহার এড়িয়ে চলাই ভালো।
```
```c++
একটি সম্ভাব্য পরিস্থিতি হল যখন আমরা প্রচুর মান যোগ করছি। ধরা যাক যে আমাদের 0 থেকে m−1 এর মধ্যে দুটি ভেরিয়েবল a এবং b আছে। তারপর আমরা লিখতে পারি:
	res = a + b;
	if ( res >= m ) res -= m;
এই কৌশলটি কাজ করবে না যখন আমরা দুটি মান গুণ করছি।
```

### মডিউল শক্তিশালী কৌশল
